...
urlpatterns = [
    ...
    path('lunch_detail/<int:id>/', views.lunch_detail, name='lunch_detail'),
    path('lunch_reserve/', views.lunch_reserve, name='lunch_reserve'),
    path('lunch_complete/<int:id>/', views.lunch_complete, name='lunch_complete'),
    path('charge/', views.charge, name='charge'),  # 충전 페이지

    path('supplier/', views.supplier, name='supplier'),

    path('write_ingredients/', views.write_ingredients, name='write_ingredients'),
    path('write_ingredients/<int:id>/', views.write_ingredients, name='write_ingredients'),
